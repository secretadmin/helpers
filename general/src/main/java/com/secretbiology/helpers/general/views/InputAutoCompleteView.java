...
public class InputAutoCompleteView extends LinearLayout {
     ...
     * Constructors
     */
    public InputAutoCompleteView(Context context, AttributeSet attrs) {
        super(context, attrs);
        extractAttribute(context, attrs);
    }

    public InputAutoCompleteView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public InputAutoCompleteView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void build(Context context) {
        ...
        inflater.inflate(R.layout.com_secretbiology_auto_input_view, this);
    }
    ...
    protected void onFinishInflate() {
        ...
        layout = (TextInputLayout) this.findViewById(R.id.com_secretbiology_auto_inputLayout);
        editText = (AutoCompleteTextView) this.findViewById(R.id.com_secretbiology_auto_input);
        setDefaults();
    }
